...
const LoadingOverlay: React.FC<LoadingOverlayProps> = ({
  message = "Please wait while we add the items to the list, this will take a few seconds",
}) => {
  ...
  return (
    <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-black/60 backdrop-blur-sm rounded-2xl p-6 text-center">
